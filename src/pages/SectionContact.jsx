    ...
    <section id="contact">
      <footer className="bg-dark text-center text-white">
        ...
        <div className="container p-3 pb-0 mb-3">
          ...
          {/* Instagram */}
          <a className="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/_lifeofyse" role="button" rel="noopener noreferrer" target="_blank">
        ...
        <div className="text-center p-3" style={{ backgroundColor: "rgba(0, 0, 0, 0.2)" }}>
          <p id="year">© {thisYear()} Copyright: All rights reserved.</p>
        </div>
        {/* Copyright */}
      </footer>
    </section>
